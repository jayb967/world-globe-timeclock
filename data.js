...
return [
    ...
    { lat: 49.2827, lng: -123.1207, label: `Vancouver, Canada ${tick(timezones[1])}` }, // For Vancouver
    ...
    { lat: 48.8566, lng: 2.3522, label: `Paris ${tick(timezones[19])}` },
    // { lat: -23.5475, lng: -46.63611, label: `Sao Paulo ${tick(timezones[5])}` },
    { lat: -22.9068, lng: -43.1729, label: `Rio de Janeiro ${tick(timezones[5])}` },
    ...
    { lat: 35.6762, lng: 139.6503, label: `Tokyo ${tick(timezones[18])}` },
